...
export default function Projects() {
    ...
    const currentWorkspaceId = useSelector(state => state.workspace.currentWorkspace?._id);
    ...
    // Fetch projects when workspace ID changes (only the ID, not the whole object)
    useEffect(() => {
        ...
        <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="relative w-full max-w-sm">
                    ...
                    <input onChange={(e) => setSearchTerm(e.target.value)} value={searchTerm} className="w-full pl-10 text-sm pr-4 py-2 rounded-lg border border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-400 focus:border-blue-500 outline-none" placeholder={t('projects.search')} />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading ? (
                    <div className="col-span-full text-center py-16">
                        ...
                        <p className="text-gray-500 dark:text-zinc-400 mt-4">{t('projects.loading')}</p>
                    </div>
