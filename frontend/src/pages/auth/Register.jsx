...
import { ArrowRight, Eye, EyeOff, User, Mail, Lock, Sparkles, CheckCircle2, Shield } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-zinc-950 dark:via-blue-950/20 dark:to-purple-950/20 px-4 py-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-purple-400/20 dark:bg-purple-500/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-blue-400/20 dark:bg-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-gray-200/50 dark:border-zinc-800/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mb-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-11 pr-4 py-3 border-2 border-gray-300 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-500 focus:border-purple-500 dark:focus:border-purple-500 outline-none transition-all bg-white dark:bg-zinc-800/50 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-500"
                />
              </div>
            </div>
            ...
            {/* Password */}
            <div>
              <label htmlFor="password" className="block text-sm font-semibold text-gray-700 dark:text-zinc-300 mb-2">
                {t('auth.password')}
              </label>
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-zinc-500">
                ...
                <input
                  ...
                  required
                  className="w-full pl-11 pr-12 py-3 border-2 border-gray-300 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-500 focus:border-purple-500 dark:focus:border-purple-500 outline-none transition-all bg-white dark:bg-zinc-800/50 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-500"
                />
                <button
                  type="button"
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-semibold text-gray-700 dark:text-zinc-300 mb-2">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-zinc-400 mb-6">
              ...
              <Link to="/login" className="text-purple-600 dark:text-purple-400 font-semibold hover:text-purple-700 dark:hover:text-purple-300 transition-colors">
                {t('auth.signIn')}
              </Link>
            </p>
            ...
            <div className="pt-6 border-t border-gray-200 dark:border-zinc-800">
              <p className="text-xs text-gray-500 dark:text-zinc-500 mb-3 font-medium">{t('auth.featuresTitleRegister')}</p>
              <div className="flex items-center justify-center gap-4 text-xs text-gray-600 dark:text-zinc-400">
                ...
                <div className="flex items-center gap-1">
                  <CheckCircle2 size={14} className="text-purple-600 dark:text-purple-400" />
                  <span>{t('auth.featureUnlimited')}</span>
                </div>
                <div className="flex items-center gap-1">
                  <CheckCircle2 size={14} className="text-purple-600 dark:text-purple-400" />
